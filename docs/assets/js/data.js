...
window.URIENIX_DATA = {
  ...
  /* ---------- Career ----------
     One entry per engagement, any order: main.js sorts by `start`, newest
     first. Dates are 'YYYY-MM' (or just 'YYYY' when the month is not worth
     stating; then no duration is shown) and `end: null` means ongoing.
     `kind` is 'job' (default), 'contract', 'consulting' or 'internship' and
     prints as a tag. `projects` lists ids from the projects block below;
     they render as chips that open the same Details modal. */

  jobs: [
    {
      id: 'higher',
      role: {
        en: 'Tech Lead · Full-Stack Engineer',
        es: 'Tech Lead · Ingeniero Full-Stack',
      },
      company: 'Higher Honduras',
      product: {
        en: 'Whole Bible Community and three client sites',
        es: 'Whole Bible Community y tres sitios de clientes',
      },
      location: { en: 'Tegucigalpa, HN', es: 'Tegucigalpa, HN' },
      start: '2025-07',
      end:   null,
      tags: ['NestJS', 'React', 'Next.js', 'Flutter', 'MongoDB', 'RabbitMQ', 'DigitalOcean'],
      projects: ['wbc', 'dalamarhomes', 'homev', 'elglobalnews'],
      highlights: {
        en: [
          'Tech lead of a small team: architecture, planning and code review across backend, web and mobile.',
          'Shipped Whole Bible Community end to end, web, backend, admin and mobile in both stores, with a queue-based video pipeline.',
          'Coordinated three client sites and their domains, including the rescue of an infected WordPress.',
        ],
        es: [
          'Tech lead de un equipo pequeño: arquitectura, planificación y revisión de código en backend, web y móvil.',
          'Lancé Whole Bible Community de punta a punta, web, backend, admin y móvil en ambas tiendas, con un pipeline de video por colas.',
          'Coordiné tres sitios de clientes y sus dominios, incluido el rescate de un WordPress infectado.',
        ],
      },
    },
    {
      ...
      product: {
        en: 'Lodging platform and a home health care app',
        es: 'Plataforma de alojamiento y una app de cuidados a domicilio',
      },
      ...
      kind:  'contract',
      remote: true,
      tags: ['React', 'Koa', 'TypeScript', 'AWS', 'MySQL', 'Stripe', 'Supabase'],
      projects: ['lodging', 'clvhh'],
      highlights: {
        en: [
          'Wired Mews, Stripe, Twilio, Vonage, Postmark and SaltoKS locks into a reservations platform on Koa + AWS.',
          'S3 uploads with image compression for the admin panel; cut cloud storage costs about 30%.',
          'Google, Microsoft and email + password auth on Supabase for the health care app.',
        ],
        es: [
          'Conecté Mews, Stripe, Twilio, Vonage, Postmark y cerraduras SaltoKS a una plataforma de reservas sobre Koa + AWS.',
          'Subidas a S3 con compresión de imágenes para el panel admin; reduje cerca de 30% el costo de almacenamiento.',
          'Autenticación con Google, Microsoft y usuario + contraseña sobre Supabase para la app de cuidados.',
        ],
      },
    },
    {
      ...
      product: {
        en: 'VirtualMoore HN · training and evaluation platform',
        es: 'VirtualMoore HN · plataforma de capacitación y evaluación',
      },
      location: { en: 'Tegucigalpa, HN', es: 'Tegucigalpa, HN' },
      start: '2021-06',
      end:   '2024-02',
      ...
      projects: ['virtualmoore'],
      highlights: {
        en: [
          'Set up, branded and ran a Moodle platform for internal courses, with domain, SSL and user support.',
          'Semi-automated grading and reports cut evaluation effort about 85% (20h to 3h a week).',
        ],
        es: [
          'Monté, personalicé y administré una plataforma Moodle para cursos internos, con dominio, SSL y soporte a usuarios.',
          'La calificación semi-automática y los reportes redujeron el esfuerzo de evaluación cerca de 85% (de 20h a 3h semanales).',
        ],
      },
    },
    {
      ...
      product: {
        en: 'Domain, Google Workspace and security advisory',
        es: 'Dominio, Google Workspace y asesoría de seguridad',
      },
      ...
      highlights: {
        en: [
          'Deployed Google Workspace company-wide and administer it since 2021.',
          'Domain, DNS, mailbox lifecycle and basic security guidance, on call for the odd special case.',
        ],
        es: [
          'Implementé Google Workspace para toda la empresa y lo administro desde 2021.',
          'Dominio, DNS, alta y baja de correos y asesoría básica de seguridad, disponible para el caso especial ocasional.',
        ],
      },
    },
    {
      ...
      company: 'Grupo Incova / Mantun',
      product: {
        en: 'Mantun GPS and Smart Driver',
        es: 'Mantun GPS y Smart Driver',
      },
      location: { en: 'Tegucigalpa, HN', es: 'Tegucigalpa, HN' },
      start: '2020-10',
      end:   '2024-03',
      tags: ['Node.js', 'Express', 'MongoDB', 'SQL Server', 'Socket.IO', 'TCP', 'Google Maps'],
      projects: ['mantungps', 'smartdriver'],
      highlights: {
        en: [
          'Built Mantun GPS: live fleet map, reporting, REST API for the mobile apps and a TCP library speaking the trackers\' own protocol.',
          'Built Smart Driver end to end; automation cut coordination load about 50% and reporting about 70%.',
        ],
        es: [
          'Construí Mantun GPS: mapa de flota en vivo, reportería, REST API para las apps móviles y una librería TCP con el protocolo propio de los rastreadores.',
          'Construí Smart Driver de punta a punta; la automatización redujo cerca de 50% la carga de coordinación y 70% la de reportes.',
        ],
      },
    },
    {
      id: 'silverhill',
      role: {
        en: 'Substitute Teacher · IT Support',
        es: 'Docente sustituto · Soporte IT',
      },
      company: 'Silver Hill School',
      product: {
        en: 'The school\'s first website and day-to-day IT',
        es: 'La primera web de la escuela y el IT del día a día',
      },
      location: { en: 'Tegucigalpa, HN', es: 'Tegucigalpa, HN' },
      start: '2019',
      end:   '2020',
      ...
      highlights: {
        en: [
          'Built the school\'s original website (silverhillschool.com, since retired) while covering classes.',
          'First line of help for the school\'s technical needs.',
        ],
        es: [
          'Creé la web original de la escuela (silverhillschool.com, ya retirada) mientras cubría clases.',
          'Primera línea de apoyo para las necesidades técnicas de la escuela.',
        ],
      },
    },
    {
      ...
      role: {
        ...
        es: 'Alumno colaborador',
      },
      company: 'CEUTEC Tegucigalpa',
      product: {
        en: 'Outreach hours tracking system',
        es: 'Sistema de control de horas de vinculación',
      },
      location: { en: 'Tegucigalpa, HN', es: 'Tegucigalpa, HN' },
      start: '2019',
      end:   '2019',
      ...
      highlights: {
        en: [
          'Beyond the usual assignments, built a system to track students\' community outreach hours in VB.NET on MS Access.',
        ],
        es: [
          'Además de las asignaciones habituales, creé un sistema de control de horas de vinculación en VB.NET sobre MS Access.',
        ],
      },
    },
  ],
